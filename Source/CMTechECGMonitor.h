...
#define ECG_ADV_IN_CONNECTION_EVT                         0x0004
#define ECG_ECGMONITOR_EVT                                0x0008
 ...
 */
extern void CMTechECGMonitor_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 CMTechECGMonitor_ProcessEvent( uint8 task_id, uint16 events );
